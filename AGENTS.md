...
- Keep default engineering sample counts aligned with the contract-facing case config: `num_train=30`, `num_test=20`, `num_lf=30`, `num_hf=15`, `num_active_initial=2`, `num_infill=21`.
